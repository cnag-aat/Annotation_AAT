...
class CreateConfigurationFile(object):
    ...
    def __init__(self):
       ...
       # self.RM_gff = None                                 #Path to the Repeat Masker gff output.
        ...
        self.geneid_introns_time = "1:00:00"
        self.geneid_introns_queue = "genD"
        self.geneid_introns_mem = "5G"
...
####
    ...
    def storeGeneidArraySpecParameters(self,args):
        ...
        self.geneidArraySpecParameters["array"] = "1-{masked_chunks}%1"
    ...
    def storeGeneidIntronsArraySpecParameters(self,args):
        ...
        self.geneidIntronsArraySpecParameters["array"] = "1-{masked_chunks}%1"
...
if args.run_geneid:
  if args.masked_chunks > 1:   
    specManager.storeGeneidArraySpecParameters(args)
  else:
    specManager.storeGeneidSpecParameters(args)

if args.run_geneid_introns:
  if args.masked_chunks > 1:   
    specManager.storeGeneidIntronsArraySpecParameters(args)
  else:
